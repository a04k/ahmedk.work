...
import { t as Route } from "./_slug-BkLX3ReJ.js";
import { jsx, jsxs } from "react/jsx-runtime";
import { Image } from "@unpic/react";
//#region app/projects/$slug.jsx?tsr-split=component
function Project() {
	const project = Route.useLoaderData();
	if (!project) return /* @__PURE__ */ jsx("div", { children: "Project not found" });
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(BackButton, {}), /* @__PURE__ */ jsxs("article", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("div", { dangerouslySetInnerHTML: { __html: project.content } }),
						project.link && /* @__PURE__ */ jsx("div", {
							className: "mt-6",
