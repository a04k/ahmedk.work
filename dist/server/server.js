...
import { createRawStreamRPCPlugin, createSerializationAdapter, defaultSerovalPlugins, executeRewriteInput, invariant, isNotFound, isRedirect, isResolvedRedirect, makeSerovalPlugin, parseRedirect, rootRouteId } from "@tanstack/router-core";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-cY9c8Ymy.js");
...
var manifest = {
	"8887bae6a16969c8ac42e0e037a1f04d60dd0655163d9facbc1ee1333950f74d": {
		functionName: "fetchProjects_createServerFn_handler",
		importer: () => import("./assets/projects-DZv39WN-.js")
	},
	"fc82fa4cdb8daf96ba96aa5f07db8ae17ad57f137286f61690136459b2eaa96d": {
		functionName: "fetchPost_createServerFn_handler",
		importer: () => import("./assets/_slug-9foVI0SQ.js")
	},
	"73a81e84d7c8f1950ffee578332b33c6d04fdfb18f2a32bd37b499037314f95e": {
		functionName: "fetchProject_createServerFn_handler",
		importer: () => import("./assets/_slug-DcihRtX-.js")
	},
	"47ecb0a1f702bcbdf79d7275733f53352338b066e5c2ebc8f160272d651c4b68": {
		functionName: "fetchPosts_createServerFn_handler",
		importer: () => import("./assets/blog-D4hnFpkM.js")
	},
	"397ff6fd383601b7deff884b89773044f3feaa7fe68cd9eb99c567072632b435": {
		functionName: "fetchPosts_createServerFn_handler",
		importer: () => import("./assets/app-D6nmcs5Q.js")
	}
};
...
async function loadEntries() {
	const routerEntry = await import("./assets/router-By4gyJo0.js");
	return {
		startEntry: await import("./assets/start-CI1ZbdI9.js"),
		routerEntry
	};
}
function getEntries() {
