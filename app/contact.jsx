    ...
    <Container className="mt-16 sm:mt-32">
      <div className="xl:relative">
        <div className="max-w-2xl mx-auto">
          ...
          <BlurTitle delay={50}>
          <div className="mb-12">
            <h1 className="text-5xl lg:text-7xl font-InstrumentSerif text-black dark:text-white mb-6">
              Get in Touch
            </h1>
          ...
          <div className="relative">
            {isSuccess ? (
              ...
              >
                ...
                <h3 className="text-2xl font-InstrumentSerif text-black dark:text-white mb-2">
                  Message Sent!
                </h3>
