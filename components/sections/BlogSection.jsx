    ...
    >
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-base text-black font-mono dark:text-neutral-400 max-w-2xl">
        ...
        <Link
          href="/blog"
          className="hidden sm:flex items-center gap-2 px-6 py-3 text-sm font-medium text-neutral-900 dark:text-white border border-neutral-300/50 dark:border-neutral-700/50 rounded-full bg-white/30 dark:bg-black/20 backdrop-blur-sm hover:bg-white/50 dark:hover:bg-black/30 transition-all duration-300"
        >
          View all articles
          <ArrowRight size={16} />
        </Link>
