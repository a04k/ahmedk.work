...
export default function Footer() {
  return (
    <footer className="bg-black/20 border-y text-white py-8 md:py-16">
      <div className="max-w-6xl mx-auto px-4 md:px-6">
        <div className="flex flex-col lg:flex-row lg:justify-between gap-6 md:gap-8">
          ...
          <div className="lg:flex-shrink-0">
            ...
            <p className="text-neutral-400 text-sm mb-4 md:mb-6">swe.</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-3 gap-6 md:gap-8 lg:gap-12 lg:ml-auto lg:max-w-2xl">
            ...
            <div className="min-w-0">
              <h4 className="text-neutral-300 font-medium mb-3 md:mb-4">Me</h4>
            ...
            {/* This Site Column */}
            <div className="min-w-0">
              <h4 className="text-neutral-300 font-medium mb-3 md:mb-4">
                This site
              </h4>
              <ul className="space-y-1.5 md:space-y-2">
                <li>
                ...
                <ul className="space-y-1.5 md:space-y-2">
                  <li>
                    <Link
                      ...
                      className="text-neutral-400 hover:text-white transition-colors text-sm inline-flex items-center gap-1 py-1"
                    >
        ...
        <div className="mt-8 md:mt-12 pt-6 md:pt-8 border-t border-neutral-800">
          <p className="text-neutral-300 text-xs text-center md:text-right">
            Cairo:{" "}
