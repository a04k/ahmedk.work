    ...
    <div className="relative h-full w-full overflow-hidden z-10">
      ...
      >
        {content.map((item, i) => (
          ...
          >
            <div className="group flex h-14 w-full items-center justify-center rounded-xl border border-neutral-200/80 bg-white dark:border-[#2f2f2f] dark:bg-[#18171C] hover:bg-neutral-50 dark:hover:bg-neutral-800 transition-colors">
              {item.icon}
            </div>
          </Link>
        ))}
